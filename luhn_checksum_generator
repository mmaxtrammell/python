...
while True:
    credit_card_number = generate_16_digit_number()

    print("Generated credit card number is: " + str(credit_card_number))
    ...
    if (sum_of_array(product_list) % 10) == 0:
        ...
        print("Valid generated credit card number is: " + str(credit_card_number))
        break
    else:
